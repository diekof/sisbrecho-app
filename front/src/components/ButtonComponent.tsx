...
export function TextButtonPrimary(props: ButtonProps) {
    return <Button {...props} severity='success' text />
}

export function TextButtonSecondary(props: ButtonProps) {
    return <Button {...props} severity='secondary' text />
}
